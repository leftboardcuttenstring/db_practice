...
select
	...
	having Departments.Department_faculty_abbreviation = 'PAM';
go
...
select
	...
	inner join Heads_of_departments_table Heads_of_department
		on P_Employees.Employee_in_table_number != Heads_of_department.Head_of_department_employee_in_table_number;
go
...
select distinct
	...
	having Exams.Exam_date between '05.06.2015' and '17.06.2015';
go
...
select distinct
	*
	...
	left outer join Exams_table Exams 
		on Students.Student_registration_number = Exams.Exam_in_registration_number
	where Exams.Exam_date = '05.06.2015';
go